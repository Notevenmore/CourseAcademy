...
<section class="admin" id="page-top">
    <div id="wrapper">
        @include('layouts.sidebaradmin')
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                @include('layouts.navbar')
                <div class="container-fluid" style="background-color: #aaa3a3">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp {{ $total_money_per_month }}</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Mentor</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $total_mentor }}</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div class="card-body">
                                    <canvas id="chart" width="300" height="70"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
